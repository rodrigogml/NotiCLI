...
2. Run `noticli send --config ./noticli.json --recipient ops --channel email --title "Test" --message "Email notification test"`.
...
2. Run `noticli send --config ./noticli.json --recipient ops --channel telegram --title "Test" --message "Telegram notification test"`.
...
2. Run `noticli send --config ./noticli.json --recipient ops --channel slack --title "Test" --message "Slack notification test"`.
...
1. Run `noticli send --config ./noticli.json --channel email --title "Test" --message "Missing recipient"`.
...
1. Run `noticli send --config ./missing.json --recipient ops --channel email --title "Test" --message "Missing config"`.
...
2. Run `noticli send --config ./noticli.json --recipient ops --channel telegram --title "Test" --message "Invalid config"`.
...
1. Run `noticli send --config ./noticli.json --recipient ops --channel email --title "Test" --message "Attachment test" --attach ./missing-file.txt`.
...
2. Run `noticli send --config ./noticli.json --recipient ops --channel slack --title "Test" --message "Delivery failure test"`.
